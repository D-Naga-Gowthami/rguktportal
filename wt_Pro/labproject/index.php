    ...
    <div class="container">
            ...
            if($result){
                ...
                if($row['email']==$email){
                    if($row['password']==$password){
                        ...
                        header('Location: bloodiconpage.html');
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="images/undraw_engineering_team_a7n2.svg" alt="" class="image">
            </div>
            ...
            <div class="panel right-panel">
                <div class="content">
                    <h3>One of us?</h3>
                    <p>
                        this our website developed by sravani and bujji 
                    </p>
                    <input type="submit" name="submit1" value="Sign Up">
                </div>
                <img src="images/undraw_brainstorming_re_1lmw.svg" alt="" class="image">
            </div>
        </div>
    </div>
